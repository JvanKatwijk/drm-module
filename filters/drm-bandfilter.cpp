 ...
 *
 *    This file is part of the sdrconenct drm module
 *
 ...
 *
 *    drm module plugin is distributed in the hope that it will be useful,
...
//	windowing, according to Blackman
	...
	for (int i = 0; i < filterSize; i ++) {	// shifting
	   ...
	   filterKernel [i] = Complex (filterBase [i] * cos (v), 
	                                           filterBase [i] * sin (v));
	}
}
...
Complex drmBandfilter::Pass (Complex z) {
