...
//
static inline
Complex	valueFor (float amp, int16_t phase) {
	return Complex (amp * cos (2 * M_PI * phase / 1024),
...
Complex getFreqRef (uint8_t Mode, int16_t symbol, int16_t carrier) {
struct timeCells *table;
...
Complex	getPilotValue (uint8_t Mode, uint8_t Spectrum,
	                               int16_t symbol, int16_t carrier) {
