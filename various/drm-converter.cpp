 ...
 *
 *    This file is part of the sdrconnect drm module for sdrconnect
 *
...
bool	converter_9600::convert		(std::complex<float> v,
	...
	int outP = 0;
	for (int i = 0; i < 960; i ++) {
	   out [outP ++] = theFilter. Pass (v * 5.0f);
...
bool	converter_12000::convert	(Complex v, Complex *out,
	                                 int * amount) {
	buffer [inP ++] = v;
	if (inP < 1200) {
	   *amount = 0;
	...
	for (int i = 0; i < 1200; i ++) {
	   out [outP ++] = theFilter. Pass (buffer [i] * 4.0f);
	   out [outP ++] = theFilter. Pass (Complex (0, 0));
	   out [outP ++] = theFilter. Pass (Complex (0, 0));
	   out [outP ++] = theFilter. Pass (Complex (0, 0));
	}
	*amount = 4800;
...
bool	converter_19200::convert	(std::complex<float> v,
	                                 std::complex<float> *out,
	                                 int *amount) {
	buffer [inP ++] = theFilter. Pass (v * 11.0f);
	for (int i = 1; i < 10; i ++) {
...
bool	converter_24000::convert	(std::complex<float> v,
	                                 std::complex<float> *out,
	                                 int *amount) {
	buffer [inP ++] = theFilter. Pass (v * 2.0f);
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
	if (inP < 4800) {
	   *amount = 0;
	   return false;
...
bool	converter_32000::convert	(std::complex<float> v,
	                                 std::complex<float> *out,
	                                 int *amount) {
	buffer [inP ++] = theFilter. Pass (v * 3.0f);
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
	if (inP < 1200) {
	   *amount = 0;
...
bool	converter_38400::convert	(std::complex<float> v,
	                                 std::complex<float> *out,
	                                 int *amount) {
	buffer [inP ++] = theFilter. Pass (v * 5.0f);
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
	buffer [inP ++] = theFilter. Pass (std::complex<float> (0, 0));
